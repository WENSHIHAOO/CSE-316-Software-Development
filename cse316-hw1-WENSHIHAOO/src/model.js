export default class Model {
  ...
  newQuestion(nData){
    this.data.questions.push(nData);
  }

  newTag(nData){
    this.data.tags.push(nData);
  }

  newAnswer(qIndex, nData){
    this.data.questions[qIndex].answers.push(nData.aid);
    this.data.answers.push(nData);
  }
}
