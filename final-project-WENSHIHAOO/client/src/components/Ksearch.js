            ...
            <table key={nSearch[i]._id}>
              <tbody>
                <tr>
                  ...
                  <td className="column3"> Asked By <span className='askedBy'>{nSearch[i].askedBy.name}</span></td>
                </tr>
                <tr>
                  <td className="column1">{nSearch[i].answers.length} Answers</td>
                  <td className="column2">{nSearch[i].summary}</td>
                  <td className="column3"> On <span className='askedOn'>{nSearch[i].askedOn}</span></td>
                </tr>
                <tr>
                  <td className="column1">{nSearch[i].votes} Votes</td>
                  <td className="column2">{tagIdToTag(nSearch, i, tTT, this.props.state.tags)}</td>
